...
public:
     ...
     */
    BasicStepperDriver(short steps, GPIO_TypeDef* dir_gpiox, short dir_pin, GPIO_TypeDef* step_gpiox, short step_pin);
    BasicStepperDriver(short steps,  GPIO_TypeDef* dir_gpiox, short dir_pin, GPIO_TypeDef* step_gpiox, short step_pin,  GPIO_TypeDef* enable_gpiox, short enable_pin);
    /*
